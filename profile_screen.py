...
class ProfileScreen:
    ...
    def _ensure(self):
        if self._title_font is None:
            ...
            m = get_mobile_scale()
            self._title_font = typo.display_bold(int(64 * m))
            self._tab_font = typo.body_bold(int(36 * m))
            self._body_font = typo.body(int(28 * m))
            self._small_font = typo.body(int(22 * m))
            self._number_font = typo.header_bold(int(56 * m))
    ...
    def draw(self, prof):
        ...
        tab_w = min(296, int(SCREEN_WIDTH * 0.116))
        tab_y = 184
        tab_h = int(70 * get_mobile_scale())
        ...
        bw, bh = int(288 * get_mobile_scale()), int(70 * get_mobile_scale())
    ...
    def _draw_stats(self, prof, th):
        ...
        cols = 4
        cw, ch = min(416, int(SCREEN_WIDTH * 0.163)), min(176, int(SCREEN_HEIGHT * 0.122))
        gap = 32
    ...
    def _draw_achievements(self, prof, th):
        ...
        cols = 3
        cw, ch = min(560, int(SCREEN_WIDTH * 0.219)), min(112, int(SCREEN_HEIGHT * 0.078))
        gap_x, gap_y = 32, 20
    ...
    def _draw_themes(self, prof, th):
        ...
        n = len(display_keys)
        pw, ph = min(432, int(SCREEN_WIDTH * 0.169)), min(320, int(SCREEN_HEIGHT * 0.222))
        gap = 56
...
class HowToPlayScreen:
    ...
    def _ensure(self):
        if self._title_font is None:
            import typography as typo
            m = get_mobile_scale()
            self._title_font = typo.display_bold(int(58 * m))
            self._head_font = typo.header_bold(int(36 * m))
            self._body_font = typo.body(int(28 * m))
    ...
    def draw(self):
        ...
        col_w = min(1280, SCREEN_WIDTH - 80)
